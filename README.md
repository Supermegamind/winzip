...
## Рекомендации по использованию в лабораторной

1. Преподаватель:
   - Запускает `zip_gen.py` с нужными паролями и методами.
   - Раздаёт студентам полученные `.txt`-файлы (или реальные `.zip`).

2. Студенты:
   - Получают задание.
   - Подбирают подходящую маску.
   - Запускают `zip_cracker.py`.
   - Демонстрируют найденный пароль и статистику.
